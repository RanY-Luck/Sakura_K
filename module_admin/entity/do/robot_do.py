...
class Robot(BaseModel):
    ...
    robot_type = Column(String(10), nullable=False, default='', comment='机器人类型')
    robot_template = Column(String(255), nullable=False, default='', comment='机器人通知模板')
    robot_status = Column(String(1), nullable=False, default='0', comment='机器人状态（0正常 1停用）')
