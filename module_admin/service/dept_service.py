...
class DeptService:
    ...
    async def get_dept_for_edit_option_services(
            cls, query_db: AsyncSession, page_object: DeptModel,
            data_scope_sql: str
    ):
        """
        获取部门编辑部门树信息service
    ...
    async def add_dept_services(cls, query_db: AsyncSession, page_object: DeptModel):
        ...
        dept = await DeptDao.get_dept_detail_by_info(
            query_db, DeptModel(
                parentId=page_object.parent_id,
    ...
    async def edit_dept_services(cls, query_db: AsyncSession, page_object: DeptModel):
        ...
        if dept_info:
            ...
            try:
                ...
                await cls.update_children_info(
                    query_db, DeptModel(
                        deptId=page_object.dept_id,
