...
async def change_system_user_profile_avatar(
    ...
    try:
        ...
        try:
            ...
            pass
        avatar_name = f'avatar_{datetime.datetime.now().strftime("%Y%m%d%H%M%S")}{UploadConfig.UPLOAD_MACHINE}{UploadUtil.generate_random_number()}.png'
