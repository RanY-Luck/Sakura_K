...
def upgrade():
    ...
    sa.Column('is_reset_password', sa.Boolean(), nullable=True, comment='是否已经重置密码，没有重置的，登陆系统后必须重置密码'),
    ...
    sa.Column('is_wx_server_openid', sa.Boolean(), nullable=True, comment='是否已有服务端微信平台openid'),
    sa.PrimaryKeyConstraint('id'),
    comment='用户表'
    )
